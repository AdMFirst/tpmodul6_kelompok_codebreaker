...
{
	public class KuliahMahasiswa1302204047
	{
		...
		{
			string fileName = "tp6_2_1302204047.json";

			string jsonString = File.ReadAllText(fileName);
			KuliahMahasiswa1302204047[] jsonData = JsonSerializer.Deserialize<KuliahMahasiswa1302204047[]>(jsonString);

			int i = 1;
			Console.WriteLine("Daftar mata kuliah yang diambil");
			foreach (KuliahMahasiswa1302204047 K in jsonData)
			{
